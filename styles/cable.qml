...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.16.1-Hannover" minScale="100000000" readOnly="0" simplifyLocal="1" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingHints="1">
  <flags>
  ...
  <DiagramLayerSettings zIndex="0" dist="0" placement="2" showAll="1" priority="0" linePlacementFlags="18" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
