...
SOURCES = \
	__init__.py \
	dxf_to_shapes.py dxf_to_shapes_dockwidget.py

PLUGINNAME = dxf_to_shapes

PY_FILES = \
	__init__.py \
	dxf_to_shapes.py dxf_to_shapes_dockwidget.py

UI_FILES = dxf_to_shapes_dockwidget_base.ui
...
QGISDIR=C:\Users\x-wing\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
